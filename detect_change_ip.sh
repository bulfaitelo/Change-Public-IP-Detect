...
####===---|{ EMAIL A SEREM USADOS
DMAIL=`luizpeterli@gmail.com`
SMAIL=`jnr.lzcarlos@gmail.com.br`
CMAIL=`thiagorodriguesmelo@hotmail.com`

####===---|{ CRIANDO O ARQUIVO TEMPORARIO PARA O ARMAZENAMENTO DA MENSAGEM DE EMAIL
rm -f /tmp/ede.html; touch /tmp/ede.html


#echo "from: $DMAIL" >> /tmp/ede.html
#echo "To: $SMAIL" >> /tmp/ede.html
#echo "cc: $CMAIL" >> /tmp/ede.html
#echo "address: jnr.lzcarlos@gmail.com (Monitoramento)"
#echo "Subject: Aviso! O Número de IP Público da máquina $NDM mudou! em $DTI" >> /tmp/ede.html
